...
const API_BASE_URL = "http://192.168.1.4:3000/api/access"; // Adjust the base URL as needed
...
export const getMemberAccessHistory = async (): Promise<AccessHistoryResponse> => {
  try {
